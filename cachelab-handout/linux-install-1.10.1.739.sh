...
curl -O https://download.clojure.org/install/clojure-tools-1.10.1.739.tar.gz
tar xzf clojure-tools-1.10.1.739.tar.gz
...
install -Dm644 clojure-tools/clojure-tools-1.10.1.739.jar "$clojure_lib_dir/libexec/clojure-tools-1.10.1.739.jar"
...
rm -rf clojure-tools
rm -rf clojure-tools-1.10.1.739.tar.gz
